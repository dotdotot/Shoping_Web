				...
				<ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4" style="">
					...
					<li class="nav-item dropdown"><a
						...
						<ul class="dropdown-menu" aria-labelledby="navbarDropdown"
							style="width: 500px">
							<li><a class="dropdown-item" href="../config/Product_list.jsp">추천 상품</a></li>
	       ...
	       <!-- Product_cart 쿼리 -->
			...
			%>
					...
					<ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4"
						...
						<li class="nav-item" style=""><a class="nav-link" href="../logout.jsp">로그아웃</a></li>
						<li class="nav-item" style=""><a class="nav-link" href="#!">마이페이지</a></li>
						<li class="nav-item" style=""><a class="nav-link" href=""><%=session.getAttribute("id")%>님 환영합니다!</a></li>
					</ul>
				</form>
			</div>
		</div>
